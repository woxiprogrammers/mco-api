    ...
    public function getPurchaseOrderDetail(Request $request){
        try{
            ...
            foreach($purchaseOrder->purchaseOrderComponent as $key => $purchaseOrderComponent){
                ...
                $purchaseOrderList['materials'][$iterator]['cgst_percentage'] = $purchaseOrderComponent['cgst_percentage'];
                $purchaseOrderList['materials'][$iterator]['cgst_amount'] = $purchaseOrderComponent['cgst_amount'];
                $purchaseOrderList['materials'][$iterator]['sgst_percentage'] = $purchaseOrderComponent['sgst_percentage'];
                $purchaseOrderList['materials'][$iterator]['sgst_amount'] = $purchaseOrderComponent['sgst_amount'];
                $purchaseOrderList['materials'][$iterator]['igst_percentage'] = $purchaseOrderComponent['igst_percentage'];
                $purchaseOrderList['materials'][$iterator]['igst_amount'] = $purchaseOrderComponent['igst_amount'];
                $purchaseOrderList['materials'][$iterator]['total'] = $purchaseOrderComponent['total'];
