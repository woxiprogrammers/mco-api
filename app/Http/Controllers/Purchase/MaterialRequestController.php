        ...
        try{
            ...
            foreach($materialComponentVersions as $key => $materialComponentVersion){
                ...
                switch ($materialRequestComponentStatusSlug){
                    ...
                    case 'bill-pending':
                        $data[$iterator]['id'] = $iterator;
                        $data[$iterator]['display_message'] = date('l, d F Y',strtotime($materialComponentVersion['created_at'])).' '.$materialComponentVersion['quantity'].' '.$materialComponentVersion->unit->name.' bill pending by '.$user->first_name.' '.$user->last_name.' '.$materialComponentVersion->remark;
                        $data[$iterator]['date'] = $materialComponentVersion['created_at'];
                        break;
                }
                $iterator++;
